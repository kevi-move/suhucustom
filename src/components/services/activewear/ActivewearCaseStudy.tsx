...
export default function ActivewearCaseStudy() {
  return (
          ...
          <div className="grid items-stretch lg:grid-cols-5">
            ...
            <div className="p-8 lg:col-span-3 lg:p-12">
              ...
              <h3 className="mt-4 text-2xl font-bold text-slate-900">
                Custom Activewear Collection – High-Waisted Leggings
              </h3>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
                    Need 10,000 custom high-waisted leggings with
                    moisture-wicking fabric and full sublimation branding,
                    18-day lead time.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="mt-1 space-y-1.5 text-sm leading-relaxed text-slate-600">
                    <li className="flex items-start gap-2">
                      ...
                      Recommended 4-way stretch spandex blend for compression
                      and breathability for gym use
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Applied full sublimation printing and custom waistband
                      labels
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Delivered full order 1 day ahead of schedule, with 0
                      quality/performance issues reported
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <blockquote className="mt-6 border-l-2 border-amber-400 pl-4 text-sm italic text-slate-500">
                &ldquo;Consistent stretch quality and reliable delivery for
                fitness-focused orders — we re-ordered 15,000+ pieces for our
                summer collection.&rdquo;
              </blockquote>
