...
export default function NeckGaiterHero() {
  return (
    <div className="relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0">
        <img
          src={resolveImageSrc("YOUR_NECKGAITER_HERO_IMAGE_URL")}
          alt="Custom neck gaiter manufacturing"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav className="pt-8 text-center text-sm text-slate-400">
          ...
          <span className="mx-2">/</span>
          <span className="text-white">Neck Gaiters</span>
        </nav>
        ...
        <div className="flex min-h-[55vh] flex-col items-center justify-center py-16 text-center lg:py-24">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Custom <span className="text-amber-400">Neck Gaiter</span>{" "}
            Manufacturing
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-300">
            From outdoor adventure face shields to branded promotional neck
            gaiters — full-service design, sublimation printing, and global
            fulfillment for any order size.
          </p>

          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <QuoteButton
              title="Get a Free Quote"
              productCategory="Neck Gaiters"
