...
export default function SwimwearHero() {
  return (
    <div className="relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0">
        <img
          src={resolveImageSrc("/generated/services/swimwear/custom-swimwear-manufacturing-hero-model-right-side.png")}
          alt="Custom swimwear manufacturing"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[60vh] flex-col items-center justify-center py-16 text-center lg:py-24">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Custom <span className="text-amber-400">Swimwear</span>{" "}
            Manufacturing
          </h1>
          <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-slate-300">
            From bikinis to performance swimsuits — full-service OEM/ODM with
            UV-resistant fabrics, sublimation printing, and worldwide shipping
            for swim brands of every size.
          </p>
