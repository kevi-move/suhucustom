...
const stats = [
  { icon: "✅", value: "100 PCS", label: "MOQ (small-batch friendly)" },
  { icon: "⏱️", value: "15–20 Days", label: "Lead Time (sample + production)" },
  { icon: "🌿", value: "OEKO-TEX", label: "Standard 100, BSCI Certified" },
  { icon: "🧵", value: "4+ Options", label: "Premium Fabric Choices" },
];

const fabrics = [
  "4-Way Stretch Spandex",
  "Moisture-Wicking Polyester",
  "Buttery Soft Viscose",
  "Compression Blend",
];

export default function LeggingsOverview() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Your Reliable Custom Leggings Manufacturer
            </h2>
            ...
            <div className="mt-10 border-l-2 border-slate-200 pl-5">
              <p className="text-base leading-relaxed text-slate-600">
                We specialize in custom leggings production for global fashion
                brands, fitness labels, DTC retailers, and lifestyle brands.
                From high-waisted and compression leggings to casual and
                athletic styles, our full-service OEM/ODM solution covers
                design, sampling, mass production, and global
                shipping—tailored to deliver comfort, durability, and style
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-3xl">
              <img
                src={resolveImageSrc("/generated/services/leggings/suhucustom-leggings-small-factory-overview-oem-odm-production.png")}
                alt="Custom leggings factory overview"
