...
const stats = [
  { value: "80,000+", label: "Pieces Produced / Month" },
  { value: "6+", label: "Specialized Fabric Types" },
  { value: "180+", label: "Skilled Workers" },
  { value: "5,000+ ㎡", label: "Factory Area" },
];

export default function UnderwearOverview() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Your Expert Intimate Apparel Manufacturer
            </h2>
            ...
            <div className="mt-10 border-l-2 border-slate-200 pl-5">
              <p className="text-base leading-relaxed text-slate-600">
                We specialize in custom intimate apparel for global lingerie
                brands, DTC startups, and wholesale buyers. From everyday basics
                to luxury sets, our full-service OEM/ODM solution covers design,
                prototyping, mass production, and worldwide fulfillment.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-3xl">
              <img
                src={resolveImageSrc("YOUR_UNDERWEAR_OVERVIEW_IMAGE_URL")}
                alt="Suhu Custom intimate apparel factory overview"
                className="h-auto w-full object-cover"
              />
            </div>

            <div className="absolute -right-3 top-8 rounded-2xl bg-white px-5 py-3 shadow-lg ring-1 ring-slate-100 sm:-right-6">
              <p className="text-xl font-extrabold text-slate-900">30+</p>
              <p className="text-xs text-slate-500">Cup Sizes Supported</p>
            </div>
            ...
            <div className="absolute -left-3 bottom-12 rounded-2xl bg-white px-5 py-3 shadow-lg ring-1 ring-slate-100 sm:-left-6">
              ...
              <p className="text-xs text-slate-500">Certified Materials</p>
            </div>
          </div>
        </div>
      </div>
