...
export default function HatCaseStudy() {
  return (
          ...
          <div className="grid lg:grid-cols-5">
            ...
            <div className="p-8 lg:col-span-3 lg:p-12">
              ...
              <h3 className="mt-4 text-2xl font-bold text-slate-900">
                Custom Embroidered Snapback Collection
              </h3>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
                    Need 8,000 custom snapback caps with 3D puff embroidery,
                    woven interior labels, and custom colorways across 6 SKUs,
                    within 15 days.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="mt-1 space-y-1.5 text-sm leading-relaxed text-slate-600">
                    <li className="flex items-start gap-2">
                      ...
                      Premium cotton twill with structured crown and flat brim
                      construction
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      3D puff embroidery on front with flat embroidery on side
                      and back
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Custom snap closure, woven interior label, and branded
                      sticker on brim
                    </li>
                  </ul>
                </div>
              ...
              <blockquote className="mt-6 border-l-2 border-amber-400 pl-4 text-sm italic text-slate-500">
                &ldquo;Best cap quality we&apos;ve ever had — the embroidery
                pops and the fit is on point. Already planning a bucket hat
                collection.&rdquo;
              </blockquote>
