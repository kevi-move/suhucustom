...
const stats = [
  { value: "60,000+", label: "Hats Produced / Month" },
  { value: "15+", label: "Hat Styles Available" },
  { value: "100+", label: "Skilled Workers" },
  { value: "3,500+ ㎡", label: "Factory Area" },
];

export default function HatOverview() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Your Reliable Custom Headwear Manufacturer
            </h2>
            ...
            <div className="mt-10 border-l-2 border-slate-200 pl-5">
              <p className="text-base leading-relaxed text-slate-600">
                We specialize in custom headwear for streetwear brands, sports
                teams, promotional clients, and fashion labels. From structured
                caps to soft beanies, our full-service OEM/ODM solution covers
                design, sampling, embroidery, and global delivery.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -right-3 top-8 rounded-2xl bg-white px-5 py-3 shadow-lg ring-1 ring-slate-100 sm:-right-6">
              ...
              <p className="text-xs text-slate-500">Brand Partners</p>
            </div>

            <div className="absolute -left-3 bottom-12 rounded-2xl bg-white px-5 py-3 shadow-lg ring-1 ring-slate-100 sm:-left-6">
              <p className="text-xl font-extrabold text-slate-900">24h</p>
              <p className="text-xs text-slate-500">Sample Turnaround</p>
            </div>
          </div>
        </div>
      </div>
