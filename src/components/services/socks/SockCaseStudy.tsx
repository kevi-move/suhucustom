const results = [
  { label: "Pairs Delivered", value: "20,000+" },
  { label: "Re-order Volume", value: "50,000+" },
  { label: "Quality Issues", value: "Zero" },
  { label: "Delivery", value: "On Time" },
];

export default function SockCaseStudy() {
  return (
          ...
          <div className="grid lg:grid-cols-5">
            ...
            <div className="p-8 lg:col-span-3 lg:p-12">
              <div className="inline-flex items-center rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-700">
                European Running Brand
              </div>

              <h3 className="mt-4 text-2xl font-bold text-slate-900">
                Performance Running Sock Collection
              </h3>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
                    Required 20,000 pairs of cushioned running socks with arch
                    support, moisture-wicking fibers, and custom jacquard branding
                    across 4 colorways.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="mt-1 space-y-1.5 text-sm leading-relaxed text-slate-600">
                    <li className="flex items-start gap-2">
                      ...
                      Developed a Coolmax / combed cotton blend for optimal
                      moisture management
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Integrated 200-needle jacquard logo and mesh ventilation
                      zones
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Delivered full order on schedule with zero quality defects
                      reported
                    </li>
                  </ul>
                </div>
              ...
              <blockquote className="mt-6 border-l-2 border-amber-400 pl-4 text-sm italic text-slate-500">
                &ldquo;The quality and consistency exceeded our expectations —
                we&apos;ve placed a 50,000-pair reorder for next season.&rdquo;
              </blockquote>
