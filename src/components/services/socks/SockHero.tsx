...
export default function SockHero() {
  return (
    <div className="relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0">
        <img
          src={resolveImageSrc("/generated/services/socks/custom-sock-manufacturing-hero-model-right-side.png")}
          alt="Custom sock manufacturing"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav className="pt-8 text-center text-sm text-slate-400">
          ...
          <span className="mx-2">/</span>
          <span className="text-white">Socks</span>
        </nav>
        ...
        <div className="flex min-h-[55vh] flex-col items-center justify-center py-16 text-center lg:py-24">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Custom <span className="text-amber-400">Sock</span> Manufacturing
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-300">
            From athletic performance socks to fashion dress socks — full-service
            design, knitting, finishing, and global delivery for brands of every
            scale.
          </p>
