          ...
          <div className="grid lg:grid-cols-5">
            ...
            <div className="p-8 lg:col-span-3 lg:p-12">
              ...
              <h3 className="mt-4 text-2xl font-bold text-slate-900">
                Custom Selvedge Denim Collection
              </h3>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
                    Need 3,000 pairs of selvedge denim jeans with custom wash
                    treatments and branded hardware, within a 25-day lead time.
                  </p>
                </div>
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">
                  ...
                  <ul className="mt-1 space-y-1.5 text-sm leading-relaxed text-slate-600">
                    <li className="flex items-start gap-2">
                      ...
                      Sourced 14oz Japanese selvedge denim with custom indigo
                      dyeing
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Applied stone wash + hand-distressing for vintage aesthetic
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Custom YKK zippers, branded rivets, and leather patch with
                      debossed logo
                    </li>
                  </ul>
                </div>
              ...
              <blockquote className="mt-6 border-l-2 border-amber-400 pl-4 text-sm italic text-slate-500">
                &ldquo;Exceptional denim quality — our customers can&apos;t
                believe these are custom manufactured. Already planning our next
                collection.&rdquo;
              </blockquote>
