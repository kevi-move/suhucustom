...
const features = [
  {
    ...
    description:
      "We source premium denim from top mills — selvedge, raw, stretch, and organic cotton options from 8oz to 16oz.",
    image: "YOUR_JEANS_FABRIC_IMAGE_URL",
  },
  {
    title: "Expert Washing & Finishing",
    description:
      "Stone wash, enzyme wash, acid wash, sandblast, and hand-distressing techniques for authentic, fashion-forward looks.",
    image: "YOUR_JEANS_WASHING_IMAGE_URL",
  },
  {
    title: "Precision Construction",
    description:
      "Chain-stitch hemming, bar-tack reinforcement, and felled seams built for durability and premium quality.",
    image: "YOUR_JEANS_CONSTRUCTION_IMAGE_URL",
  },
  {
    title: "Custom Hardware",
    description:
      "Branded rivets, buttons, zippers (YKK/custom), and leather patches — every detail customizable to your brand.",
    image: "YOUR_JEANS_HARDWARE_IMAGE_URL",
  },
  {
    title: "Strict Quality Control",
    description:
      "5-step QC: fabric inspection → cutting audit → sewing check → wash verification → final packaging review.",
    image: "YOUR_JEANS_QC_IMAGE_URL",
  },
];
