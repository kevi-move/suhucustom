...
export default function TowelHero() {
  return (
    <div className="relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0">
        <img
          src={resolveImageSrc("/generated/services/towels/custom-towel-manufacturing-hero-small-sample-room.png")}
          alt="Custom towel manufacturing"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex min-h-[55vh] flex-col items-center justify-center py-16 text-center lg:py-24">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Custom <span className="text-amber-400">Towel</span>{" "}
            Manufacturing
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-300">
            From plush hotel bath towels to branded beach towels and sports
            towels — premium weaving, custom designs, and reliable global
            delivery for hospitality and retail brands.
          </p>
