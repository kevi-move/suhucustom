...
export default function LeatherCTA() {
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 lg:py-28">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <h2 className="mt-6 text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
          ...
          <span className="text-amber-400">Custom Leather Goods</span>?
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-lg text-slate-400">
          Get a free quote and prototype in 7 days — no obligation to order.
        </p>
        ...
        <p className="mt-6 text-sm text-slate-500">
          MOQ as low as 50 PCS · Prototype ready in 5–7 days · Genuine leather certified
        </p>
      </div>
    </div>
  );
