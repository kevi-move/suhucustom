  ...
  return (
    <div className="relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0">
        <img
          src={resolveImageSrc("/generated/services/leather-goods/custom-leather-goods-manufacturing-hero-model-right-side.png")}
          alt="Custom leather goods manufacturing"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav className="pt-8 text-center text-sm text-slate-400">
          ...
          <span className="mx-2">/</span>
          <span className="text-white">Leather Goods</span>
        </nav>
        ...
        <div className="flex min-h-[55vh] flex-col items-center justify-center py-16 text-center lg:py-24">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Custom <span className="text-amber-400">Leather Goods</span>{" "}
            Manufacturing
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-300">
            From premium wallets and belts to bespoke bags and accessories —
            expert craftsmanship, fine materials, and global delivery for luxury
