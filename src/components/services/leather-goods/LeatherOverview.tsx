...
const stats = [
  { value: "10,000+", label: "Pieces Produced / Month" },
  { value: "6+", label: "Craftsmanship Stations" },
  { value: "80+", label: "Master Artisans" },
  { value: "3,000+ ㎡", label: "Workshop Area" },
];

export default function LeatherOverview() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Your Premium Custom Leather Goods Manufacturer
            </h2>
            ...
            <div className="mt-10 border-l-2 border-slate-200 pl-5">
              <p className="text-base leading-relaxed text-slate-600">
                We craft premium leather goods for fashion houses, lifestyle
                brands, and corporate clients. From genuine Italian leather
                wallets to full-grain tote bags, our OEM/ODM workshop handles
                design, prototyping, production, and worldwide shipping.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-3 bottom-12 rounded-2xl bg-white px-5 py-3 shadow-lg ring-1 ring-slate-100 sm:-left-6">
              <p className="text-xl font-extrabold text-slate-900">2,000+</p>
