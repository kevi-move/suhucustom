...
export default function HoodieCaseStudy() {
  return (
          ...
          <div className="grid lg:grid-cols-5">
            ...
            <div className="p-8 lg:col-span-3 lg:p-12">
              ...
              <h3 className="mt-4 text-2xl font-bold text-slate-900">
                Winter Collection – Custom Zip-Up Hoodies
              </h3>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
                    Need 8,000 custom zip-up hoodies with heavyweight fleece and
                    3D chest embroidery, within a 20-day lead time.
                  </p>
                </div>
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">
                  ...
                  <ul className="mt-1 space-y-1.5 text-sm leading-relaxed text-slate-600">
                    <li className="flex items-start gap-2">
                      ...
                      Recommended 320 GSM cotton fleece for warmth and premium
                      hand feel
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
                      Applied 3D puff embroidery and custom woven drawstring tips
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
              ...
              <blockquote className="mt-6 border-l-2 border-amber-400 pl-4 text-sm italic text-slate-500">
                &ldquo;Consistent quality and reliable communication — we
                re-ordered 12,000+ pieces for our next seasonal drop.&rdquo;
              </blockquote>
